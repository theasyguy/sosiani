                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('location') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }}" name="location" id="input-email" type="text" placeholder="{{ __('Location') }}" value="{{ old('location') }}" required />
                ...
                <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group{{ $errors->has('contact') ? ' has-danger' : '' }}">
                              <input class="form-control{{ $errors->has('contact') ? ' is-invalid' : '' }}" name="contact" id="input-email" type="text" placeholder="{{ __('Contact person') }}" value="{{ old('contact') }}" required />
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                              <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" id="input-email" type="text" placeholder="{{ __('Phone No.') }}" value="{{ old('phone') }}" required />
                              @if ($errors->has('phone'))
