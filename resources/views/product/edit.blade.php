                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('variety') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('variety') ? ' is-invalid' : '' }}" name="variety" id="input-name" type="text" placeholder="{{ __('Variety Name') }}" value="{{ old('variety', $product->variety) }}" required="true" aria-required="true"/>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('length') ? ' has-danger' : '' }}">
                                            <select class="form-control{{ $errors->has('length') ? ' is-invalid' : '' }}" name="length" id="input-email" required>
                                                <option value="{{ old('length', $product->length) }}">{{ old('length', $product->length) }}</option>
                                                <option>80CM</option>
                                                <option>60CM</option>
                                                <option>50CM</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group{{ $errors->has('stems') ? ' has-danger' : '' }}">
                                            ...
                                            <input class="form-control{{ $errors->has('stems') ? ' is-invalid' : '' }} slider" min="120" max="400"  step="10" value="{{ old('contact', $product->stems) }}" name="stems" id="myRange" type="range" placeholder="{{ __('No. of stems') }}" required />
